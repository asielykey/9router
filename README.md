...
🎉 Dashboard opens at `http://localhost:20228`
...
- Dashboard: `http://localhost:20228/dashboard`
- OpenAI-compatible API: `http://localhost:20228/v1`
...
| `PORT`                                               | framework default                        | Service port (`20228` in examples)                                                  |
| `HOSTNAME`                                           | framework default                        | Bind host (Docker defaults to `0.0.0.0`)                                            |
| `NODE_ENV`                                           | runtime default                          | Set `production` for deploy                                                         |
| `BASE_URL`                                           | `http://localhost:20228`                 | Server-side internal base URL used by cloud sync jobs                               |
...
- Set `PORT=20228` and `NEXT_PUBLIC_BASE_URL=http://localhost:20228`
