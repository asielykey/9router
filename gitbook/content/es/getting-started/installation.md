...
**Qué sucede:**
1. El servidor inicia en `http://localhost:20228`
...
```bash
curl http://localhost:20228/v1/models \
...
**Error:**
```
Error: listen EADDRINUSE: address already in use :::20228
```

**Solución 1: Mata el proceso existente**

```bash
# Encuentra proceso usando el puerto 20228
lsof -i :20228
...
server {
    ...
    location / {
        proxy_pass http://localhost:20228;
