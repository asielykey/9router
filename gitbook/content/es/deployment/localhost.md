...
- **API Endpoint**: `http://localhost:20228/v1`
...
El puerto de API (20228) y el puerto del dashboard (3000) están configurados en la aplicación. Para cambiarlos, necesitarás modificar el código fuente o usar variables de entorno si se soportan.
...
Si el puerto 20228 o 3000 ya está en uso:
