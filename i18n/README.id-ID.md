...
🎉 Dashboard terbuka di `http://localhost:20228`
...
- API kompatibel OpenAI: `http://localhost:20228/v1`
...
docker run -d \
  ...
  -e PORT=20228 \
  -e BASE_URL=http://localhost:20228 \
...
```bash
npm install -g 9router
PORT=20228 HOSTNAME=0.0.0.0 BASE_URL=https://your-domain.com 9router
```
...
|---------|----------------------|--------|
| Tool CLI tidak bisa konek | Endpoint salah | Pastikan `http://localhost:20228/v1` |
