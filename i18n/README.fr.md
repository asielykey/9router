...
🎉 Le tableau de bord s'ouvre sur `http://localhost:20228`
...
- Tableau de bord : `http://localhost:20228/dashboard`
- API compatible OpenAI : `http://localhost:20228/v1`
...
| `PORT`                                               | défaut du framework                         | Port du service (`20228` dans les exemples)                                                   |
...
| `BASE_URL`                                           | `http://localhost:20228`                    | URL de base interne côté serveur utilisée par les tâches de synchronisation cloud             |
...
- Définissez `PORT=20228` et `NEXT_PUBLIC_BASE_URL=http://localhost:20228`
