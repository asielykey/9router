...
🎉 El panel de control se abre en `http://localhost:20228`
...
- Panel de control: `http://localhost:20228/dashboard`
- API compatible con OpenAI: `http://localhost:20228/v1`
...
docker run -d --name 9router -p 20228:20228 \
...
| `PORT`                                               | por defecto del framework                  | Puerto del servicio (`20228` en los ejemplos)                                        |
...
| `BASE_URL`                                           | `http://localhost:20228`                   | URL base interna del lado del servidor usada por los trabajos de sincronización en la nube |
...
- Establece `PORT=20228` y `NEXT_PUBLIC_BASE_URL=http://localhost:20228`
