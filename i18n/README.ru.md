...
🎉 Панель управления откроется на `http://localhost:20228`
...
URL по умолчанию:
- Панель управления: `http://localhost:20228/dashboard`
- OpenAI-совместимый API: `http://localhost:20228/v1`
...
| `PORT` | framework default | Порт сервиса (`20228` в примерах) |
...
| `BASE_URL` | `http://localhost:20228` | Внутренний серверный базовый URL для задач облачной синхронизации |
...
- Установите `PORT=20228` и `NEXT_PUBLIC_BASE_URL=http://localhost:20228`

**Ошибки облачной синхронизации**
- Убедитесь, что `BASE_URL` указывает на ваш работающий инстанс (например, `http://localhost:20228`)
...
- Локально (`http://127.0.0.1:20228/v1/chat/completions`): работает с `stream=false` и `stream=true`.
